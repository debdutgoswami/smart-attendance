...
class Class(Resource):
    def post(self):
        ...
        pui, cname, endroll = (
            dict(request.form)['pui'],
            dict(request.form)['cname'],
            int(dict(request.form)['endroll']))
...
class Update(Resource):
    def post(self):
        ...
        pui, cui, endroll, ab, timestamp = dict(request.form)['pui'], dict(request.form)['cui'], int(
            dict(request.form)['endroll']), list(map(int, str(dict(request.form)['absent']).strip('{}').split(','))), \
                                           dict(request.form)['timestamp']
